...
function displayResult(bmi) {
    ...
    if (bmi >= 23 && bmi <= 25) {
        document.querySelector("#result-section h2").innerText = "berat badan normal";
        document.querySelector("#result-section p").innerText = "anda memiliki berat badan ideal";
    } else {
